...
const QUESTS = [
  ...
  },
  {
    ...
    icon: Palette,
    title: "Farbe",
    tagline: "Finde etwas Rotes in der Wohnung",
    xp: 15,
    difficulty: 1,
    clue: "Rot leuchtet überall, wenn man genau hinsieht — ein Kissen, ein Apfel, ein Spielzeug. Such dir dein Lieblingsrot!",
    color: "#b03a3a",
  },
  {
    id: "q10",
    icon: HandHeart,
    title: "Herzen",
    tagline: "Fotografiere Eure Hände zu einem Herzen gefaltet",
    xp: 15,
    difficulty: 1,
    clue: "Formt mit euren Händen gemeinsam ein Herz — allein, zu zweit oder zu dritt — und fotografiert es von oben.",
    color: "#e06a8a",
  },
  {
    id: "q11",
    icon: Package,
    title: "Geschenk",
    tagline: "Fotografiere das schönste Geschenk",
    xp: 15,
    difficulty: 2,
    clue: "Welches Päckchen ist heute am schönsten verpackt? Halte es fest, bevor es ausgepackt wird!",
    color: "#b8913a",
  },
  {
    id: "q12",
    icon: Volume2,
    title: "Geräusche",
    tagline: "Fotografiere etwas, das Geräusche macht",
    xp: 15,
    difficulty: 2,
    clue: "Eine Uhr, ein Instrument, eine quietschende Tür — hör gut hin und fang das laute Ding mit der Kamera ein.",
    color: "#c9a43a",
  },
  {
    id: "q13",
    icon: Circle,
    title: "Formen",
    tagline: "Fotografiere etwas Rundes",
    xp: 10,
    difficulty: 1,
    clue: "Rund wie ein Ball, ein Teller, ein Luftballon, ein Knopf. Finde die schönste Kugel!",
    color: "#4a85b5",
  },
  {
    id: "q14",
    icon: Utensils,
    title: "Tischdeko",
    tagline: "Fotografiere die Tischdeko, die Dir am besten gefällt",
    xp: 15,
    difficulty: 1,
    clue: "Blumen, Servietten, Kerzen, kleine Figuren — welches Detail auf dem Tisch zaubert dir ein Lächeln ins Gesicht?",
    color: "#6b8c5a",
  },
  {
    id: "q15",
    icon: Baby,
    title: "Gäste",
    tagline: "Finde den jüngsten Gast",
    xp: 20,
    difficulty: 3,
    clue: "Irgendwo unter den Gästen versteckt sich der oder die Jüngste. Frag nett nach einem Foto — eine echte Detektiv-Aufgabe!",
    color: "#8c7ab8",
  },
  {
    id: "q16",
    icon: Hand,
    title: "Winken",
    tagline: "Zum Abschied ein Foto, in dem Ihr winkt",
    xp: 15,
    difficulty: 1,
    clue: "Wenn die Party vorbei ist: winkt alle zusammen in die Kamera — ein letztes Hallo und Tschüss!",
    color: "#d6a84a",
  },
];
